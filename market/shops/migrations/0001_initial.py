        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price",
                    models.DecimalField(
                        blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name="цена"
                    ),
                ),
                (
                    "discount_price",
                    models.DecimalField(decimal_places=2, max_digits=10, verbose_name="цена со скидкой"),
                ),
