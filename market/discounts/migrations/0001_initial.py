        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "products",
                    models.ManyToManyField(
                        blank=True, related_name="shop_items_discounts", to="products.product", verbose_name="товары"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="максимальное количество товаров в корзине"
                    ),
                ),
                (
                    "products_group_1",
